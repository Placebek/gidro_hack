            ...
            >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    <div
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.transform = "scale(1.09) rotate(3deg)";
                            e.currentTarget.style.boxShadow = "0 10px 25px rgba(0, 191, 255, 0.45)";
                        }}
                        onMouseLeave={(e) => {
                ...
                <nav style={{ display: "flex", alignItems: "center", gap: "2rem" }}>
                    ...
                    <Link
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.color = "#008fc7";
                    ...
                    {/* Объекты и Приоритизация */}
                    {["Объекты", "Приоритизация", "Прогноз паводков"].map((text) => (
                        <Link
                            key={text}
                            to={
                                text === "Объекты"
                            ...
                            onMouseEnter={(e) => {
                                e.currentTarget.style.color = "#00BFFF";
                                e.currentTarget.style.transform = "translateY(-1px)";
                                e.currentTarget.style.textShadow = "0 0 6px rgba(0,191,255,0.4)";
                            }}
                            onMouseLeave={(e) => {
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => {
                            e.currentTarget.style.backgroundColor = "#009edc";
                            e.currentTarget.style.boxShadow = "0 6px 20px rgba(0, 191, 255, 0.4)";
