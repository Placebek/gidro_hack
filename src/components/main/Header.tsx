                ...
                <div className="relative">
                    ...
                    {isDropdownOpen && isLoggedIn && (
                        <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden animate-in slide-in-from-top-2 duration-200">
                            <div className="p-4 bg-linear-to-r from-cyan-500 to-blue-600 text-white cursor-pointer">
                            ...
                            <div className="py-2">
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-5 py-3 hover:bg-gray-50 transition cursor-pointer text-left"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-5 py-3 hover:bg-red-50 text-red-600  cursor-pointer transition"
                                >
